...
if uploaded_files:
    ...
    if st.button("Run Top-Trader Analysis"):
        ...
        Analyze the trend, pattern, and best Entry, Stop Loss, and Take Profit.
        ...
        **CRITICAL FORMAT RULES:**
        ...
        2. DO NOT calculate lot sizes, leverage, or margin. DO NOT add extra characters to the numbers.
        """
        try:
